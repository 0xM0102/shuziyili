import { weatherIconSrc } from "@/lib/weather/icon-map";
...
export function WeatherConditionIcon({
  ...
  return (
    // eslint-disable-next-line @next/next/no-img-element -- 小体积静态 WebP，避免 Image 优化开销
    <img
      src={weatherIconSrc(weatherText)}
      alt=""
      width={size}
      height={size}
      className={className}
...
/** 定位 / 我的位置（地图定位 pin） */
export function WeatherLocateIcon({ className }: IconProps) {
  return (
    <svg
      ...
      aria-hidden
    >
      <path d="M422 427.023a90 90 0 1 0 180 0 90 90 0 1 0-180 0z" />
      <path
